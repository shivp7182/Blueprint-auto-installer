...
#      Compatible with Ubuntu + Pterodactyl
#      Created by UnknownPixel — Fully Optimized
#=========================================================
...
echo -e "${GREEN}AUTO BLUEPRINT INSTALLER made by UnknownPixel — Optimized Version${RESET}"
echo
